...
export interface paths {
  ...
  "/items/works": {
     ...
     * @description Delete multiple existing works items.
     */
    delete: operations["deleteItemsWorks"];
    /**
  ...
  "/items/works/{id}": {
    ...
    /**
     * Delete an Item
     * @description Delete an existing works item.
     */
    delete: operations["deleteSingleItemsWorks"];
    /**
     * Update an Item
  ...
  "/items/comments": {
    ...
    /**
     * Create an Item
     * @description Create a new comments item.
     */
    post: operations["createItemsComments"];
    /**
     * Delete Multiple Items
     * @description Delete multiple existing comments items.
     */
    delete: operations["deleteItemsComments"];
    /**
     * Update Multiple Items
     * @description Update multiple comments items at the same time.
     */
    patch: operations["updateItemsComments"];
  };
  "/items/comments/{id}": {
    /**
     * Retrieve an Item
    ...
    /**
     * Delete an Item
     * @description Delete an existing comments item.
     */
    delete: operations["deleteSingleItemsComments"];
    /**
     * Update an Item
     * @description Update an existing comments item.
     */
    patch: operations["updateSingleItemsComments"];
  };
  "/users": {
    /**
     * List Users
  ...
  "/items/creators": {
    /**
     * List Items
     * @description List the creators items.
     */
    get: operations["readItemsCreators"];
    /**
     * Create an Item
     * @description Create a new creators item.
     */
    post: operations["createItemsCreators"];
    /**
     * Delete Multiple Items
     * @description Delete multiple existing creators items.
     */
    delete: operations["deleteItemsCreators"];
    /**
     * Update Multiple Items
     * @description Update multiple creators items at the same time.
     */
    patch: operations["updateItemsCreators"];
  };
  "/items/creators/{id}": {
    /**
     * Retrieve an Item
     * @description Retrieve a single creators item by unique identifier.
     */
    get: operations["readSingleItemsCreators"];
    /**
     * Delete an Item
     * @description Delete an existing creators item.
     */
    delete: operations["deleteSingleItemsCreators"];
    /**
     * Update an Item
     * @description Update an existing creators item.
     */
    patch: operations["updateSingleItemsCreators"];
  };
}
...
export interface components {
  schemas: {
    ...
    ItemsWorks: {
      ...
      title?: string | null;
      description?: string | null;
      creator?: number | components["schemas"]["ItemsCreators"] | null;
    ...
    ItemsComments: {
      ...
      work?: number | components["schemas"]["ItemsWorks"] | null;
      content?: string | null;
    };
    ItemsCategories: {
      id?: number;
    ...
    ItemsGlobal: {
      ...
      title?: string | null;
      description?: string | null;
      writer_cover?: string | components["schemas"]["Files"] | null;
    };
    ItemsCreators: {
      id?: number;
      status?: string;
...
export interface operations {
  ...
  createItemsWorks: {
    ...
    requestBody?: {
      content: {
        "application/json": components["schemas"]["ItemsWorks"][] | components["schemas"]["ItemsWorks"];
      };
    };
    responses: {
      /** @description Successful request */
  ...
  createItemsComments: {
    ...
    requestBody?: {
      content: {
        "application/json": components["schemas"]["ItemsComments"][] | components["schemas"]["ItemsComments"];
      };
    };
    responses: {
      /** @description Successful request */
  ...
  updateSingleItemsComments: {
    ...
    requestBody?: {
      content: {
        "application/json": components["schemas"]["ItemsComments"];
      };
    };
    responses: {
      /** @description Successful request */
  ...
  readItemsCreators: {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": {
            data?: components["schemas"]["ItemsCreators"][];
            meta?: components["schemas"]["x-metadata"];
          };
        };
      };
  ...
  createItemsCreators: {
    ...
    requestBody?: {
      content: {
        "application/json": components["schemas"]["ItemsCreators"][] | components["schemas"]["ItemsCreators"];
      };
    };
    responses: {
      /** @description Successful request */
  ...
  updateSingleItemsCreators: {
    ...
    requestBody?: {
      content: {
        "application/json": components["schemas"]["ItemsCreators"];
      };
    };
    responses: {
      /** @description Successful request */
...
export type ApiCollections = {
  works: components["schemas"]["ItemsWorks"][];
  comments: components["schemas"]["ItemsComments"][];
  categories: components["schemas"]["ItemsCategories"][];
  global: components["schemas"]["ItemsGlobal"][];
  creators: components["schemas"]["ItemsCreators"][];
};
